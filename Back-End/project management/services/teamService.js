...
exports.createTeam = asyncHandler(async (req, res, next) => {
  try {
    ...
    const {title, members, teamLeader } = req.body;
    
    // Create the team
    const team = await teamModel.create({manager: req.user._id, teamLeader,members,title});
...
exports.getTeams = asyncHandler(async (req, res , next) => {
    const teams = await teamModel.find({ manager: req.user._id })
